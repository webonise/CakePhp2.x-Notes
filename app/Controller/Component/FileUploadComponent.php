...
class FileUploadComponent extends Object {
        ...
        if ($multifile == true) {
            ...
            foreach ($formdata as $file) {
                ...
                if ($file['error'] == 0) {
                    ...
                    $resultData[] = $this->uploadFile($typeOK, $file, $folder_url, $filename, $rel_url , $permitted);
                } else {
                    $resultData[] = array();
                }
            }
    ...
    function uploadFile($typeOK, $file, $folder_url, $filename, $rel_url ,$permitted) {
        //echo $filename;die;
...
//                    var_dump(file_exists($folder_url . '/' . $filename));die;
//                    

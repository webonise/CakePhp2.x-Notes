...
$this->Html->script(array('ckeditor/ckeditor'), false);
?>
    ...
    <div class="hero-unit">
        ...
        <fieldset>
            ...
            <div class="control-group">
                ...
                <div class="controls docs-input-sizes">
                    <?php echo $this->element('ckeditor', array('name' => 'Page.body', 'id' => 'ckeditor_text')); ?>
                </div>
            </div>
            <div class="control-group">
            ...
            <div class="form-actions">
                <?php
                echo $this->Form->submit(__('Submit'), array('class' => 'btn btn-success' , 'div' => false));
